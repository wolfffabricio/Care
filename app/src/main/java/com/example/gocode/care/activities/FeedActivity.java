...
import com.example.gocode.care.adapters.TabsAdapter;
...
public class FeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TOOLBAR
        mToolbar = (Toolbar) findViewById(R.id.tbFeed);
        mToolbar.setTitle("Care");
        setSupportActionBar(mToolbar);

        //TABS
        mViewPager = (ViewPager) findViewById(R.id.vpTabs);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem item = menu.findItem(R.id.action_feed_activity);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(FeedActivity.this, ConfiguracaoActivity.class);
            startActivity(i);
            return true;
        }
