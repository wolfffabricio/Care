...
import com.example.gocode.care.activities.FeedActivityMain;
...
public class PerfisFeedFragmentMain extends Fragment implements RecyclerViewOnClickListnerHack {

    private RecyclerView mRecyclerView;
    private ArrayList<Usuario> mList;
    private SwipeRefreshLayout mSwipeRefreshLayout;

    public PerfisFeedFragmentMain() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_perfis_feed_main, container, false);

        mRecyclerView = (RecyclerView) view.findViewById(R.id.rvListMain);
        ...
        mList = ((FeedActivityMain) getActivity()).getSetUserList(11);
        UserAdapter adapter = new UserAdapter(getActivity(), mList);
        adapter.setRecyclerViewOnClickListnerHack(this);
        mRecyclerView.setAdapter(adapter);

        //SWIPE REFRESH LAYOUT
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.srlSwipeMain);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (UtilCare.verifyConnection(getActivity())) {
                    ...
                    ArrayList<Usuario> listAux = ((FeedActivityMain) getActivity()).getSetUserList(11);
